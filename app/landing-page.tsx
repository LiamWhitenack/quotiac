...
export default function LandingPage({
    ...
    return (
        <View style={landingPageStyles.container}>
            <Image source={require("@/assets/favicon.png")} style={landingPageStyles.logo} />

            <Text style={[styles.title, landingPageStyles.title]}>Quotiac</Text>

            <Text style={landingPageStyles.subtitle} numberOfLines={2} ellipsizeMode="tail">
