...
const InfiniteLockAnimation: FC<LockSvgProps> = ({ duration = 2500, width = 250, height = 300 }) => {
      ...
      <G transform="translate(0 40)">
        ...
        <AnimatedG animatedProps={animatedProps}>
          ...
          <G fill={theme.background}>
            ...
            <G
              transform="translate(62, 204) rotate(180 8 8) scale(0.03125)"
              style={animating ? {} : styles.hide}
            >
...
export default InfiniteLockAnimation;
